  ...
  if (results.multiHandLandmarks && results.multiHandedness) {
    for (let index = 0; index < results.multiHandLandmarks.length; index++) {
      ...
      if(isRightHand==false){
        ...
        pulgar_dist=landmarks[4].y*100-landmarks[5].y*100;
        indice_dist=landmarks[8].x*100-landmarks[6].x*100;
        medio_dist=landmarks[12].x*100-landmarks[11].x*100;
        anular_dist=landmarks[16].x*100-landmarks[15].x*100;
        menique_dist=landmarks[20].x*100-landmarks[19].x*100;
        indice_medio_dist=landmarks[12].y*100 - landmarks[7].y*100; 
        ...
        if (pulgar_state=="arriba" && indice_state=="arriba" && medio_state=="arriba" && anular_state=="abajo" && menique_state=="abajo" && indice_medio_dist_state=="abierto"){
